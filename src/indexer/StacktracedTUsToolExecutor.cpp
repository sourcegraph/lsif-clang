...
#include "StacktracedTUsToolExecutor.h"
...
const char *StacktracedTUsToolExecutor::ExecutorName = "StacktracedTUsToolExecutor";
...
StacktracedTUsToolExecutor::StacktracedTUsToolExecutor(
...
llvm::Error StacktracedTUsToolExecutor::execute(
    llvm::ArrayRef<
...
class StacktracedTUsToolExecutorPlugin : public ToolExecutorPlugin {
public:
  llvm::Expected<std::unique_ptr<ToolExecutor>>
  create(CommonOptionsParser &OptionsParser) override {
    if (OptionsParser.getSourcePathList().empty())
      return make_string_error(
          "[StacktracedTUsToolExecutorPlugin] Please provide a directory/file path in "
          "the compilation database.");
    return std::make_unique<StacktracedTUsToolExecutor>(std::move(OptionsParser),
                                                 ExecutorConcurrency);
  }
};

static ToolExecutorPluginRegistry::Add<StacktracedTUsToolExecutorPlugin>
...
volatile int StacktracedTUsToolExecutorAnchorSource = 0;
